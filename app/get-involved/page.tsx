...
export default function GetInvolvedPage() {
  return <main><SiteHeader />
    <InteriorHero eyebrow="We are the answer" title="There is a place for" accent="you here." intro="You do not need organizing experience to make a difference. Start with the kind of participation that fits your time, interests, and community." tone="gold" image="/media/images/p21-volunteers-donations-warehouse.webp?v=20260811-2" imageAlt="Two volunteers smiling while working in a donation warehouse." imagePosition="60% center" />
