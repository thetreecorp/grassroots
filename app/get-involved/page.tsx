...
export default function GetInvolvedPage() {
  return <main><SiteHeader />
    <InteriorHero eyebrow="We are the answer" title="There is a place for" accent="you here." intro="You do not need organizing experience to make a difference. Start with the kind of participation that fits your time, interests, and community." tone="gold" image="/media/images/p21-volunteers-donations-warehouse.webp?v=20260813" imageAlt="Young volunteers, one wearing a headscarf, sorting donations at a community center." imagePosition="center" />
